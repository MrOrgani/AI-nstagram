...
export const Icons = {
  ...
  spinninCircles: (props: IconProps) => (
    <svg
      className="animate-spin-slow	mx-auto aspect-video overflow-hidden rounded-xl object-bottom sm:w-full lg:order-last lg:aspect-square filter invert brightness-125"
      ...
      <g opacity="0.2">
        ...
        <circle
          ...
          cy="335"
          r="10"
          fill="url(#paint1_linear_1147_785)"></circle>
        <circle
          cx="187"
          cy="1029"
          r="10"
          fill="url(#paint2_linear_1147_785)"></circle>
        <circle
          cx="1184"
          cy="684"
          r="10"
          fill="url(#paint3_linear_1147_785)"></circle>
      </g>
      <defs>
        <linearGradient
          ...
          <stop offset="1" stopColor="green"></stop>
        </linearGradient>
        <linearGradient
